    ...
    >
      <div className="p-6">
        <div className="flex items-center">
          <div className="flex-shrink-0 bg-gradient-to-r from-brand-500 to-brand-400 rounded-xl p-3 shadow-md">
            {icon}
          </div>
...
export default function Dashboard() {
  ...
  if (isLoading || status === 'loading') {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[--background] via-[--background] to-brand-200">
        <div className="w-16 h-16 relative animate-spin">
          <div className="absolute inset-0 rounded-full border-4 border-gray-200"></div>
          <div className="absolute inset-0 rounded-full border-4 border-brand-500 border-t-transparent"></div>
        </div>
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[--background] via-[--background] to-brand-200">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
              ...
              <div className="mt-4 md:mt-0 flex items-center">
                ...
                <Link
                  href="/scan/upload"
                  className="ml-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-500 hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 transition-all duration-200"
                >
                  <svg
            ...
            <div className="bg-gradient-to-r from-brand-200 to-brand-100 rounded-xl p-6 mb-8 border border-brand-200 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="mt-4 sm:mt-0">
                  <span className="inline-flex items-center px-3 py-1.5 rounded-md text-sm font-medium bg-white text-[--foreground] shadow-sm border border-brand-300">
                    <svg
                      className="mr-1.5 h-4 w-4 text-brand-400"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                    >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <Link
                ...
                className="text-sm text-brand-500 hover:text-[--foreground] transition-colors duration-200 flex items-center"
              >
                View all
                <svg
              ...
              {recentScans.length > 0 ? (
                        ...
                        <div className="px-6 py-5">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              ...
                              */}
                              <div className="ml-4">
                                <p className="text-base font-medium text-brand-500 truncate">
                                  {scan.condition}
                                </p>
                            ...
                            <div className="flex items-center">
                              <div className="mr-4">
                                <div className="flex items-center">
                                  ...
                                  <span className="ml-1 text-sm font-bold text-brand-500">
                                    {scan.confidence}%
                                  </span>
                                </div>
                ...
                <div className="py-12 text-center">
                  ...
                  <div className="mt-6">
                    <Link
                      href="/scan/upload"
                      className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-brand-500 hover:brightness-110 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500"
                    >
                      <svg
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <Link
                    href="/resources"
                    className="text-sm text-brand-500 hover:text-[--foreground] font-medium flex items-center"
                  >
                    View more resources
                    <svg
                      className="ml-1 h-4 w-4"
