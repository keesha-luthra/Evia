      ...
      <div className="bg-white shadow-lg rounded-xl overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link
                href="/scan/upload"
                className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-brand-500 to-brand-400 hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 transition-all duration-200"
              >
        ...
        <div className="bg-gray-50 px-6 py-3 border-b border-gray-200">
          <div className="flex items-center text-sm text-gray-500">
            ...
            <button
              ...
              className={`mr-4 flex items-center ${sortBy === 'date' ? 'font-medium text-brand-500' : ''}`}
            >
              Date
              {sortBy === 'date' && (
            ...
            <button
              ...
              className={`mr-4 flex items-center ${sortBy === 'confidence' ? 'font-medium text-brand-500' : ''}`}
            >
              Confidence
              {sortBy === 'confidence' && (
                <svg className="ml-1 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <button
              ...
              className={`flex items-center ${sortBy === 'condition' ? 'font-medium text-brand-500' : ''}`}
            >
              Condition
              {sortBy === 'condition' && (
                <svg className="ml-1 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        {isLoading ? (
          <div className="py-12 text-center">
            <svg className="animate-spin mx-auto h-8 w-8 text-brand-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 flex-1">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-lg font-medium text-brand-500 hover:text-[--foreground]/80 transition-colors duration-200">
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="mr-4">
                            <div className="flex items-center">
                              ...
                              <span className="ml-1 text-sm font-bold text-brand-500">{scan.confidence}%</span>
                            </div>
                      ...
                      <div className="mt-3 flex justify-between items-center">
                        ...
                        <div className="flex space-x-2">
                          <button
                            ...
                            className="inline-flex items-center text-sm font-medium text-brand-500 hover:text-brand-400 transition-colors duration-200"
                          >
          ...
          <div className="py-12 text-center">
            ...
            <div className="mt-6">
              ...
              <Link
                href="/scan/upload/"
                className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-brand-500 hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500"
              >
            ...
            >
              ...
              <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <Link
                  ...
                  className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-brand-500 text-base font-medium text-white hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 sm:ml-3 sm:w-auto sm:text-sm"
                >
                  View Full Details
                </Link>
                <button
