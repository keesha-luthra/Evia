  ...
  return (
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 -z-10 overflow-hidden">
        ...
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-brand-200 rounded-full mix-blend-multiply filter blur-xl opacity-40 animate-blob animation-delay-2000"></div>
      ...
      >
        ...
        >
          <Link href="/" className="flex items-center">
            ...
            <span className="ml-3 text-3xl font-bold text-gray-900">Evia</span>
          </Link>
        </motion.div>
        ...
        <div className="bg-white py-8 px-4 shadow-2xl sm:rounded-xl sm:px-10 border border-gray-100">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            <motion.div variants={itemVariants} className="relative">
              ...
              <input
                ...
                required
                className="block w-full px-4 py-3 rounded-lg border border-gray-300 shadow-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-all duration-200 text-gray-900"
            ...
            <motion.div variants={itemVariants} className="relative">
              ...
              <input
                ...
                } shadow-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-all duration-200 text-gray-900`}
                placeholder="••••••••"
              />
          ...
          >
            <p className="text-xs text-gray-700">
              ...
              and{' '}
              <Link href="/privacy" className="text-brand-500 hover:text-brand-400 transition-colors">
                Privacy Policy
              </Link>
            </p>
          </motion.div>
