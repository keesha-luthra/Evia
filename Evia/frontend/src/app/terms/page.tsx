    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white shadow-2xl rounded-lg overflow-hidden">
        <div className="px-6 py-10 sm:px-10">
          <h1 className="text-4xl font-extrabold text-gray-900 border-b-4 border-brand-500 pb-4 mb-8">
            Terms of Service
          </h1>
          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
                <p className="text-gray-700">
                  By accessing or using the Evia skin analysis service, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our service.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4">
                <p className="text-gray-700 mb-4">
                  Evia provides AI-powered skin analysis as a supportive tool. Important disclaimers include:
                </p>
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  <li>
                  ...
                  <li>
                    Evia is not liable for any decisions made based on our analysis.
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                Evia reserves the right to modify these Terms of Service at any time. Continued use of the service after changes constitutes acceptance of the new terms.
              </p>
            </section>
          </div>
