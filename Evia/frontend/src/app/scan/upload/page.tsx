...
export default function UploadPage() {
  ...
  return (
    <div className="min-h-screen bg-[--background] flex items-center justify-center p-6 pt-24 relative">
      <MinimalNavbar />
      {/* Floating decorative elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/5 w-64 h-64 rounded-full bg-brand-200 opacity-30 blur-xl"></div>
        <div className="absolute top-2/3 left-1/5 w-72 h-72 rounded-full bg-brand-200 opacity-30 blur-xl"></div>
      </div>
      ...
      <motion.div 
        ...
        className="w-full max-w-5xl bg-white rounded-2xl shadow-xl overflow-hidden border border-brand-200"
      >
        <div className="p-6 bg-brand-500 relative">
          <motion.h1 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="grid md:grid-cols-2 gap-8 p-8 bg-brand-100/50">          
          ...
          >
            ...
            >
              ...
              {input.imagePreview ? (
                <div className="relative">
                  ...
                  />
                  <div className="absolute top-2 right-2 bg-brand-400 text-white rounded-full p-1.5 shadow">
                ...
                <div className="py-12">
                  {isUploading ? (
                    <div className="flex items-center justify-center flex-col">
                      ...
                      <p className="text-brand-500 font-medium">Processing...</p>
                    </div>
                  ) : (
                    <>
                      <div className="bg-brand-200 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <FaUpload className="text-3xl text-brand-500" />
                      </div>
                      <p className="text-gray-800 font-medium text-lg">
                        Click to Upload Image
                      </p>
                      <p className="text-brand-500 text-sm mt-2">JPG, PNG or GIF</p>
                    </>
                  )}
                </div>
              )}
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.button
                ...
                bg-brand-400 text-white py-3 rounded-xl 
                shadow-md hover:bg-brand-500 transition"
              >
          ...
          >
            <textarea
              ...
              className="w-full p-4 border-2 border-brand-200 rounded-xl 
              min-h-[250px] focus:border-brand-400 focus:ring-1 focus:ring-brand-300 focus:outline-none
              shadow-inner bg-white text-gray-800"
            />

            <div className="bg-white p-5 rounded-xl shadow border border-brand-200">
