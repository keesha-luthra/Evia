      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-6">
        ...
        {!result && (
          <button
            ...
            className="w-full bg-brand-500 text-white py-3 rounded-lg hover:brightness-110 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {result && (
          <div className="mt-6 bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="bg-brand-100 p-4 rounded-lg">
                  <p className="text-xl font-bold text-brand-500">{result.condition}</p>
                  <div className="mt-2">
              ...
              <div>
                ...
                <div className={`p-4 rounded-lg ${
                  result.severity === 'High' ? 'bg-brand-200 text-brand-500' :
                  result.severity === 'Medium' ? 'bg-brand-100 text-brand-500' :
            ...
            <div className="mt-6">
              ...
              <ul className="list-disc list-inside space-y-2 bg-brand-100 p-4 rounded-lg">
            ...
            {result.followUpQuestions && result.followUpQuestions.length > 0 && (
              <div className="mt-6 bg-brand-100 p-4 rounded-lg">
                ...
                <button
                  ...
                  className="mt-4 bg-brand-500 text-white py-2 px-4 rounded-lg"
                >
                  Submit Answers
                </button>
              </div>
            ...
            {finalTreatment && (
              <div className="mt-6 p-6 bg-brand-200 rounded-lg">
                <h2 className="text-2xl font-bold text-[--foreground] mb-4">Final Treatment Plan</h2>
                {finalTreatment.split(/\n(?=\*\*)/).map((section, idx) => {
                  ...
                  return (
                    <div key={idx} className="mb-4">
                      <h3 className="text-lg font-semibold text-[--foreground]">{title.replace(/\*\*/g, '').trim()}</h3>
                      {isList ? (
            ...
            <div className="mt-6 flex space-x-4">
              ...
              <button
                onClick={goToClinics}
                className="flex-1 bg-brand-500 text-white py-3 rounded-lg hover:brightness-110 transition"
              >
                Find Nearby Clinics
              </button>
            </div>
